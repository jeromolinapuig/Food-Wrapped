...
export function Dashboard({ session, theme, onToggleTheme }: DashboardProps) {
    ...
    return (
        <div className="bw-app-root">
                                            ...
                                            <div className="bw-history-header">
                                                <div>
                                                    <div className="bw-history-restaurant">
                                                        <span className="bw-history-meat-icon">
                                                            🍔
                                                        </span>
                                                        <span>{restaurantName}</span>
                                                    </div>
                                                    {burgerName && (
                                                        <div className="bw-history-burger-name">
                                                            {burgerName}
                                                        </div>
                                                    )}
            ...
            {/* Modal placeholder para nueva entrada */}
            {isAddModalOpen && (
                <div className="bw-modal-backdrop" onClick={closeAddModal}>
                    <div
                        className="bw-modal"
                    ...
                    >
                        <h2>Nueva comida</h2>
                        <p>
                            Aquí irá el formulario para añadir una entrada de comida
                            (fecha, foto, restaurante, hamburguesa, nota, precio…)
                        </p>
